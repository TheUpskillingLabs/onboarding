...
function FLOWS(name){
  if(name==='signup') return { eyebrow:'Your profile', finalLabel:eventsOnly()?'Sign me up':'Become an Upskiller', finalClass:'btn-red',
    ...
    steps:[
      ...
      /* The paperwork — questions first, documents last (owner decision). One
         ...
         (returning members). */
      {id:'agreeGuidelines',type:'consent',section:'The paperwork · 1 of 2',q:'The Volunteer and Participation Guidelines',help:'How we work together — read it to the end.',agreementTitle:'The Volunteer and Participation Guidelines',agreementHTML:(window.AGREEMENTS&&window.AGREEMENTS.guidelines.html)||'',text:'I have read and agree to the Volunteer and Participation Guidelines.',when:()=>!eventsOnly()&&!hasAgreed('guidelines')},
      {id:'agreeParticipation',type:'consent',section:'The paperwork · 2 of 2',q:'The Volunteer and Participation Agreement',help:'This is the deal between you and The Labs — read it to the end.',agreementTitle:'The Volunteer and Participation Agreement',agreementHTML:(window.AGREEMENTS&&window.AGREEMENTS.participation.html)||'',text:'I have read and agree to the Volunteer and Participation Agreement.',when:()=>!eventsOnly()&&!hasAgreed('participation')},
  ...
  if(name==='agreements') return { eyebrow:'Your agreements', finalLabel:'I agree', finalClass:'btn-red',
    ...
    steps:[ {id:'agreeGuidelines',type:'consent',section:'1 of 2',q:'The Volunteer and Participation Guidelines',help:'Taking on a role at The Labs starts with the documents — read it to the end.',agreementTitle:'The Volunteer and Participation Guidelines',agreementHTML:(window.AGREEMENTS&&window.AGREEMENTS.guidelines.html)||'',text:'I have read and agree to the Volunteer and Participation Guidelines.',when:()=>!hasAgreed('guidelines')},
      {id:'agreeParticipation',type:'consent',section:'2 of 2',q:'The Volunteer and Participation Agreement',help:'This is the deal between you and The Labs — read it to the end.',agreementTitle:'The Volunteer and Participation Agreement',agreementHTML:(window.AGREEMENTS&&window.AGREEMENTS.participation.html)||'',text:'I have read and agree to the Volunteer and Participation Agreement.',when:()=>!hasAgreed('participation')} ]};
